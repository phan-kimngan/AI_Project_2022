            ...
            with start:
                if st.button('Start'):
                    ...
                    if emotion or attendance or emotion_attendance:
                        ...
                        save_path = "./data/outputs/video_recorder/" + run_version_training +"/" + run_version_training + ".mp4"
                        save_new_path = "./data/outputs/video_recorder/" + run_version_training +"/h264_" + run_version_training + ".mp4"
                        save_path_csv = "_data_outputs_" + run_version_training + ".csv"
